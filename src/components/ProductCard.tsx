...
export function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <Link
      ...
      className="group flex h-full flex-col justify-between border border-border bg-paper p-6 transition-colors duration-fast hover:border-bronze/50 hover:bg-white"
    >
      <div>
