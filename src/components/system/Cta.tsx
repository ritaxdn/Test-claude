...
export function Cta({
  ...
  return (
    <Link
      href={href}
      className={cn(
        "group relative inline-flex items-center justify-between gap-4 whitespace-nowrap rounded-full py-2 pl-6 pr-2 font-sans text-sm text-deep transition-all duration-300 hover:-translate-y-0.5",
