...
/** CSS variable name (for inline radial-gradient glows) per category. */
export const categoryGlowVar: Record<CategoryKey, string> = {
  body: "--plate-body",
  face: "--plate-face",
  "hair-removal": "--plate-hair-removal",
  "hair-restoration": "--plate-hair-restoration",
};
