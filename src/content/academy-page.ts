export const academyPageContent = {
    ...
    expertise: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "Les masterclasses incluent des mises en pratique supervisées, pas uniquement de la théorie.",
        },
        {
          title: "Suivi post-formation",
          description:
            "Un accompagnement continu après la formation pour consolider la maîtrise des protocoles.",
        },
      ],
    },
    faculty: {
  ...
  en: {
    ...
    expertise: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "Masterclasses include supervised hands-on practice, not just theory.",
        },
        {
    ...
    cta: {
      title: "Join the next masterclass",
      description:
