  ...
  return (
    <>
      <main className="mx-auto max-w-3xl px-5 py-20 md:px-8">
        ...
        <h1 className="mt-10 font-display text-5xl">Mentions légales</h1>

        <div className="mt-12 space-y-10 leading-relaxed text-ink-soft [&_h2]:mb-3 [&_h2]:font-display [&_h2]:text-2xl [&_h2]:text-ink">
          <section>
